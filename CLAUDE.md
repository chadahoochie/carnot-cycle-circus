...
3. **Embedded Ticket Management (ADR-0007)**: Hierarchical decomposition ($Epics \to Stories \to Subtasks$), DAG dependency scheduling, and inter-agent handoff contracts (`HandoffPacket`).
